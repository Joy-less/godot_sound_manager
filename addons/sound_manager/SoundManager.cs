...
namespace NathanHoad
{
    public partial class SoundManager : Node
    {
        ...
        public static AudioStreamPlayer PlaySound(AudioStream resource, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_sound", resource, overrideBus);

        public static AudioStreamPlayer PlaySoundWithPitch(AudioStream resource, float pitch, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_sound_with_pitch", resource, pitch, overrideBus);
        ...
        public static AudioStreamPlayer PlayUISound(AudioStream resource, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_ui_sound", resource, overrideBus);

        public static AudioStreamPlayer PlayUISoundWithPitch(AudioStream resource, float pitch, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_ui_sound_with_pitch", resource, pitch, overrideBus);
        ...
        public static AudioStreamPlayer PlayAmbientSound(AudioStream resource, float fadeInDuration = 0.0f, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_ambient_sound", resource, fadeInDuration, overrideBus);
        ...
        public static float GetMusicVolume()
            => (float)Instance.Call("get_music_volume");
        ...
        public static AudioStreamPlayer PlayMusic(AudioStream resource, float crossFadeDuration = 0.0f, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_music", resource, crossFadeDuration, overrideBus);
        ...
        public static AudioStreamPlayer PlayMusicFromPosition(AudioStream resource, float position, float crossFadeDuration = 0.0f, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_music_from_position", resource, position, crossFadeDuration, overrideBus);
        ...
        public static AudioStreamPlayer PlayMusicAtVolume(AudioStream resource, float volume, float crossFadeDuration = 0.0f, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_music_at_volume", resource, volume, crossFadeDuration, overrideBus);
        ...
        public static AudioStreamPlayer PlayMusicFromPositionAtVolume(AudioStream resource, float position, float volume, float crossFadeDuration = 0.0f, string overrideBus = "")
            => (AudioStreamPlayer)Instance.Call("play_music_from_position_at_volume", resource, position, volume, crossFadeDuration, overrideBus);
        ...
        public static bool IsMusicTrackPlaying(string resource_path)
            => (bool)Instance.Call("is_music_track_playing", resource_path);
        ...
        public static Array<string> GetCurrentlyPlayingTracks()
            => (Array<string>)Instance.Call("get_currently_playing_tracks");
